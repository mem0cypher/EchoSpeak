...
class SessionMemoryDistiller:
    ...
    def update_turn(
        ...
        *,
        ...
        self._merge_items(state.durable_facts, self._extract_facts(combined))
        self._merge_items(state.user_preferences, self._extract_preferences(combined))
        self._merge_items(state.open_tasks, self._extract_tasks(combined))
        self._merge_items(state.unresolved_questions, self._extract_questions(combined))
        self._merge_items(state.recent_decisions, self._extract_decisions(combined))
